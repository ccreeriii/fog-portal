...
test('event frontend consumes list references, selected detail, and deduplicates list loads', async () => {
    ...
    assert.ok(serviceWorkerSource.includes("const CACHE_NAME = 'fog-portal-v24';"), 'new app asset has a fresh shell cache');
    ...
    assert.ok(indexSource.includes('<script src="/js/app.js?v=13.3"></script>'), 'index serves the coordinated app version');
