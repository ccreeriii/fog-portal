...
(function installPrivateJournalPolish(root) {
    ...
    function setupJournalShell() {
        ...
        const privacy = appendText(
            copy,
            'p',
            '🔒 Your journal is encrypted on your device before it is saved.',
    ...
    discipleship.loadJournals =
          function loadCanonicalJournalList() {
              ...
              const secureJournal =
                  root.FOGJournalSecureController;
              ...
              if (!secureJournal) {
                  ...
                  if (container) {
                      showState(
                          container,
                          'Private Journal protection is unavailable. Nothing will be sent or saved.'
                      );
                  }
              ...
              if (container) {
                  showState(
                      container,
                      'Opening your protected journal…'
                  );
              }
