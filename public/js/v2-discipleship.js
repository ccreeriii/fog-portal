window.V2Discipleship = {
    ...
    loadUserGrowthData: async function() {
        this.loadNextStep();
        // Private Journal is intentionally loaded only when the Journal sub-tab is opened.
        this.loadPrayers();
    ...
    saveJournal: async function(e) {
        if (
            ...
            alert(
                'Private Journal protection is unavailable. Nothing was sent or saved.'
            );
    ...
    openEditJournalModal: function(id) {
        if (
            ...
            alert(
                'Private Journal protection is unavailable.'
            );
    ...
    closeEditJournalModal: function() {
        if (
            !window.FOGJournalSecureController
        ) {
            return;
