...
(function () {
  ...
  const SAVE_STORAGE_KEY = 'koinonia.phase16.save';
  ...
  function updateDebugHud(force = false) {
    ...
    hud.innerHTML = `
      <strong>KOINONIA Phase 0.16 World & Places Expansion HUD</strong><br>
      ...
      Milestones: <b>${unlockedMCount} / ${totalMCount} Unlocked</b><br>
