    ...
    for (const m of MILESTONES) {
      ...
      if (cond.type === 'SKILL_XP') {
        ...
        satisfied = state.fogCenterUnlocked === true ||
                    (Array.isArray(state.unlockedPlaces) && state.unlockedPlaces.includes(cond.placeId));
      } else if (cond.type === 'PLACE_VISITED') {
        satisfied = state.visitedFogCenter === true ||
                    (state.visitedPlaces && state.visitedPlaces[cond.placeId] === true);
