...
(function () {
  ...
  const NPCS = {
    ...
    coach_daniel: {
      ...
      interactionRadius: 2.4,
      dialogue: {
        first_meeting: '"Hey there, Alex! Welcome to the Sports Hub! Your body is a temple—let\'s build strength, discipline, and teamwork through active play and Faith Quest challenges."',
        normal: '"Welcome to Faith Quest! True sportsmanship means encouraging your teammates, giving your best effort, and honoring God with healthy habits. Win or lose, personal growth is what counts."',
        quest_available: '"Ready for a challenge? Step up to the free throw line, sprint on the track, or keep a rally alive! You can also log real-world movement and teamwork encouragement."',
        quest_active: '"Stay focused on your rhythm and form. Hydrate well, encourage those around you, and remember that personal bests come with patience."',
        quest_completed: '"Outstanding effort! Remember: an athletic score doesn\'t define who you are, but the discipline, joy, and encouragement you share with others always matters."'
      }
    },
  ...
  const PLACES = {
    ...
    sports_hub: {
      ...
      zones: [
        ...
        { id: 'badminton_court', name: 'Badminton & Pickleball Court', icon: '🏸', description: 'Marked court lines and regulation center net.' },
        { id: 'track', name: 'Running Lane & Sprint Track', icon: '🏃', description: 'Perimeter running track circling the athletic fields.' },
        { id: 'fitness_zone', name: 'Fitness & Movement Zone', icon: '🧘', description: 'Shaded open mat for functional stretching and bodyweight movement.' },
      ...
      worldObjects: [
        ...
        { id: 'sports_board_obj', type: 'board', x: 2, y: 4, w: 2, h: 3, color: '#D97706', label: '📋 Faith Quest Board', solid: true },
        { id: 'sports_pb_board_obj', type: 'board', x: 2, y: 8, w: 2, h: 2, color: '#F59E0B', label: '🌟 PB Board', solid: true },
        { id: 'racket_net_obj', type: 'net', x: 16, y: 7, w: 4, h: 1, color: '#FFFFFF', label: '🏸 Racket Net', solid: true }
      ],
      ...
      interactables: [
        {
          ...
          y: 5.0,
          radius: 2.4,
          label: 'Talk to Coach Daniel (Faith Quest Guide)',
          icon: '🏃',
          dialogueNpcId: 'coach_daniel'
        },
        {
          id: 'fitquest_board',
          name: 'Faith Quest Board',
          type: 'ACTIVITY_POINT',
          x: 3.0,
          y: 5.0,
          radius: 2.2,
          label: 'FAITH QUEST BOARD — Open Faith Quest Hub',
          icon: '📋',
          action: 'open_fitquest'
        },
        {
          id: 'sports_pb_board',
          ...
          y: 8.0,
          radius: 2.2,
          label: 'Check Personal Bests',
          icon: '🌟',
          action: 'sports_pb_board'
        },
        {
          id: 'sports_hoop',
          ...
          y: 3.0,
          radius: 2.2,
          label: 'BASKETBALL — Play Free Throw Focus',
          icon: '🏀',
        ...
        },
        {
          ...
          y: 13.0,
          radius: 2.2,
          label: 'RUNNING TRACK — Play Reaction Sprint',
          icon: '🏃',
          action: 'play_running'
        },
        {
          ...
          y: 7.5,
          radius: 2.2,
          label: 'RACKET COURT — Play Rally Focus',
          icon: '🏸',
          action: 'play_rally'
        },
        {
          ...
          y: 11.0,
          radius: 2.2,
          label: 'FITNESS ZONE — Real-World Faith Quests',
          icon: '📝',
          action: 'sports_board'
        },
        {
