...
(function () {
  ...
  const NPCS = {
    ...
    coach_daniel: {
      ...
      interactionRadius: 2.4,
      dialogue: {
        first_meeting: '"Hey there, Alex! Welcome to the Sports Hub! Your body is a temple—let\'s build strength, discipline, and teamwork through active play and Fit Quest challenges."',
        normal: '"Welcome to Fit Quest! True sportsmanship means encouraging your teammates, giving your best effort, and honoring God with healthy habits. Win or lose, personal growth is what counts."',
  ...
  const PLACES = {
    ...
    sports_hub: {
      ...
      worldObjects: [
        ...
        { id: 'sports_board_obj', type: 'board', x: 2, y: 4, w: 2, h: 3, color: '#D97706', label: '📋 Fit Quest Board', solid: true },
      ...
      interactables: [
        {
          ...
          y: 5.0,
          radius: 2.4,
          label: 'Talk to Coach Daniel (Fit Quest Guide)',
          icon: '🏃',
        ...
        },
        {
          ...
          y: 5.0,
          radius: 2.2,
          label: 'FIT QUEST BOARD — Open Fit Quest Hub',
          icon: '📋',
        ...
        },
        {
          ...
          y: 11.0,
          radius: 2.2,
          label: 'FITNESS ZONE — Real-World Fit Quests',
          icon: '📝',
          action: 'sports_board'
        },
        {
