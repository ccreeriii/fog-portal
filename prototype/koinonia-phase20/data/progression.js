...
(function () {
  ...
  const MILESTONES = [
    ...
    // Sports & Fit Quest Milestones (Phase 0.18: Recognition only, 0 XP, 0 LP)
    {
      id: 'm_first_fitquest',
      category: 'SPORTS',
      title: 'First Fit Quest',
    ...
    },
    {
      ...
      description: 'Achieved a new personal best record in a Fit Quest challenge.',
      icon: '🌟',
    ...
    },
    {
      ...
      description: 'Dedicated effort across ten Fit Quest challenge attempts.',
      icon: '🔥',
