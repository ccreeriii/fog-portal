...
(function () {
  ...
  const PLACES = {
    ...
    fog_center: {
      ...
      icon: '⛪',
      accentColor: '#4B6B44', // Olive Grove
    ...
    school: {
      ...
      icon: '🏫',
      accentColor: '#2C3E55', // Dusk Indigo
    ...
    sports_hub: {
      ...
      mapCoords: { x: 500, y: 450, labelPos: 'bottom' },
      unlocked: true,
      zones: [
        { id: 'basketball_court', name: 'Basketball Court', icon: '🏀', description: 'Hardwood-textured outdoor half-court with hoop and scoreboard.' },
        { id: 'badminton_court', name: 'Badminton & Pickleball Area', icon: '🏸', description: 'Net court marked for doubles and rally practices.' },
        { id: 'running_track', name: 'Running & Fitness Track', icon: '🏃', description: 'Crushed gravel perimeter loop for stamina and endurance walking.' },
        { id: 'bleachers', name: 'Team Bleachers & Water Station', icon: '🥤', description: 'Shaded seating where players rest, rehydrate, and cheer teammates.' }
      ],
      components: [
        { id: 'c_hoop', type: 'sports_gear', name: 'Regulation Basketball Hoop', zoneId: 'basketball_court' },
        { id: 'c_scoreboard', type: 'scoreboard', name: 'FOG Match Scoreboard', zoneId: 'basketball_court' },
        { id: 'c_net', type: 'sports_gear', name: 'Badminton Net', zoneId: 'badminton_court' },
        { id: 'c_coach_marcus', type: 'npc', name: 'Marcus (Sports Coordinator)', zoneId: 'bleachers' }
      ],
      history: [
        {
          id: 'hist_sports_01',
          ...
          description: 'Team Fire (68) played Team Grace (62) in friendly competition. Alex achieved personal best 24 points.',
          badge: 'Teamwork & Discipline'
        },
        {
          id: 'hist_sports_02',
          date: 'August 2026',
          title: 'Pickleball Novice Clinic',
          description: '12 new players learned paddle techniques and court etiquette.',
          badge: 'Sportsmanship'
        }
      ]
    },
    ...
    outreach: {
      ...
      communityId: 'fog',
      name: 'Outreach Site',
      lifecycle: 'temporary', // Demonstrates temporary / event-based place lifecycle!
      category: 'Community Service',
      icon: '🤝',
      accentColor: '#3E8E58', // Fresh Mint
