...
(function () {
  ...
  const QUESTS = [
    ...
    // ============================================================
    // EVENT QUEST E-Q001: PREPARE THE GATHERING
    // ============================================================
    {
      id: 'E-Q001',
      communityId: 'fog',
      title: 'Glory Gate Gathering: Prepare the Space',
      shortTitle: 'Glory Gate Gathering',
      subtitle: 'Gathering Service • FOG Community Center',
      description: 'Help set up chairs, arrange songsheets or name tags, or prepare the room before youth and families arrive.',
      category: 'EVENT',
      categoryName: 'Event',
      eventId: 'get_into_the_glory',
      placeId: 'fog_center',
      giverNpcId: 'sister_grace',
      isEventQuest: true,
      eventLinked: true,
      ...
      steps: [
        {
          id: 'step_1',
          type: 'TALK_TO_NPC',
          title: 'Consult Sister Grace',
          description: 'Speak with Sister Grace to coordinate setup before the gathering starts.',
          npcId: 'sister_grace'
        },
        {
          id: 'step_2',
          type: 'REAL_WORLD_ACTION',
          title: 'Prepare the Gathering Space',
          description: 'Help prepare the fellowship hall, arrange seating, or set out supplies in the physical world.',
          actionPrompt: 'Help set up chairs, arrange songsheets or name tags, or prepare refreshments before friends arrive.',
          choices: [
            'Set up chairs or arrange the discussion circle',
            'Lay out welcoming name tags, pens, or handouts',
            'Help tidy and prepare the refreshment or snack station'
          ]
        },
        {
          id: 'step_3',
          ...
          description: 'Reflect on welcoming others through humble preparation.',
          prompt: 'One small thing I prepared to make others feel welcome was...',
          verification: {
            type: 'TRUST_PLUS_REFLECTION',
            requiresReflection: true
          }
      ...
      stateDialogue: {
        available: '"Peace be with you! We are preparing the space for our gathering. Would you help set things in order?"',
        active: '"Thank you for serving! Go ahead and arrange the chairs or help set out the supplies, then come back."',
        completed: '"Glory to God! The room is warm, orderly, and ready for fellowship. Thank you for your faithful hands."'
      },

      worldEffects: [],
      tags: ['event', 'gathering', 'service', 'preparation']
    },

    // ============================================================
    // EVENT QUEST E-Q002: WELCOME SOMEONE
    // ============================================================
    {
      id: 'E-Q002',
      communityId: 'fog',
      title: 'Table Fellowship: Welcome Someone',
      shortTitle: 'Table Fellowship',
      subtitle: 'Hospitality & Fellowship • FOG Community Center',
      description: 'Greet someone by name, introduce yourself to a newcomer, or sit beside someone sitting alone at the gathering.',
      category: 'EVENT',
      categoryName: 'Event',
      eventId: 'youth_hangouts',
      placeId: 'fog_center',
      giverNpcId: 'sister_grace',
      isEventQuest: true,
      eventLinked: true,
      ...
      steps: [
        {
          id: 'step_1',
          type: 'TALK_TO_NPC',
          title: 'Hear the Call to Welcome',
          description: 'Speak with Sister Grace about creating a hospitable table for everyone.',
          npcId: 'sister_grace'
        },
        {
          id: 'step_2',
          type: 'REAL_WORLD_ACTION',
          title: 'Extend Warm Welcome',
          description: 'Greet a newcomer, learn someone\'s name, or sit next to someone who came alone.',
          actionPrompt: 'Greet someone warmly in the gathering, introduce yourself, or share a welcoming word.',
          choices: [
            'Greet someone by name with a warm smile as they arrive',
            'Introduce yourself to someone new or sitting on the edge of the circle',
            'Invite someone to join your table or discussion group'
          ]
        },
        {
          id: 'step_3',
          type: 'REFLECTION',
          title: 'Open Arms Reflection',
          description: 'Reflect on the gift of belonging.',
          prompt: 'How did greeting or connecting with someone make the space feel warmer today?',
          verification: {
            type: 'TRUST_PLUS_REFLECTION',
            requiresReflection: true
          }
      ...
      stateDialogue: {
        available: '"Every person who walks through our doors is beloved by God. Look around—is there someone you can welcome today?"',
        active: '"Take a moment to step over and greet someone warmly. An open smile can change someone\'s whole week."',
        completed: '"Bless you! By making room for others, you reflect Christ\'s unconditional hospitality."'
      },

      worldEffects: [],
      tags: ['event', 'gathering', 'welcome', 'hospitality', 'fellowship']
    },

    // ============================================================
    // EVENT QUEST E-Q003: REFLECT AFTER THE GATHERING
    // ============================================================
    {
      id: 'E-Q003',
      communityId: 'fog',
      title: 'Alpha Quest: The Conversation & Examen',
      shortTitle: 'Alpha Quest: The Conversation',
      subtitle: 'Spiritual Examen • FOG Community Center',
      description: 'Take 5 quiet minutes after the gathering concludes to write down one insight, gratitude, or prayer prompt.',
      category: 'EVENT',
      categoryName: 'Event',
      eventId: 'alpha_session_event',
      placeId: 'fog_center',
      giverNpcId: 'sister_grace',
      isEventQuest: true,
      eventLinked: true,
      ...
      steps: [
        {
          id: 'step_1',
          type: 'TALK_TO_NPC',
          title: 'Examen Guidance',
          description: 'Receive quiet encouragement to savor what God spoke during the gathering.',
          npcId: 'sister_grace'
        },
        {
          id: 'step_2',
          type: 'REAL_WORLD_ACTION',
          title: 'Quiet Examen & Journaling',
          description: 'Spend 5 uninterrupted minutes in quiet reflection or write a short note in your journal.',
          actionPrompt: 'Pause in quiet reflection after the gathering and write down one meaningful takeaway.',
          choices: [
            'Write one sentence in a notebook about something that touched your heart today',
            'Spend 3 minutes in quiet prayer thanking God for the gathering and friends',
            'Send a quick encouraging message to someone who shared or served today'
          ]
        },
        {
          id: 'step_3',
          type: 'REFLECTION',
          title: 'Gathering Takeaway',
          description: 'Record your takeaway in your journey log.',
          prompt: 'One word or idea from today\'s gathering that I want to hold onto this week is...',
          verification: {
            type: 'TRUST_PLUS_REFLECTION',
            requiresReflection: true
          }
      ...
      stateDialogue: {
        available: '"The seeds sown during fellowship grow best when we give them time to settle. Take a few quiet minutes to reflect."',
        active: '"Find a quiet corner or notebook page. What did God whisper to your heart today?"',
        completed: '"Amen. Treasuring these moments in your heart turns everyday gatherings into lasting spiritual roots."'
      },

      worldEffects: [],
      tags: ['event', 'gathering', 'reflection', 'prayer', 'examen']
    }
  ];
