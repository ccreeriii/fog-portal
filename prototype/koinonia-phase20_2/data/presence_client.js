...
(function () {
  ...
  class KoinoniaPresenceClient {
    constructor(options = {}) {
      ...
      this.port = options.port || (typeof window !== 'undefined' && window.location && window.location.port ? window.location.port : 18107);
    ...
    getWebSocketUrl() {
      ...
      return `${protocol}//${host}:${this.port}${this.path}`;
    }
