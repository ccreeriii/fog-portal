...
async function runBetaTestSuite() {
  ...
  assert(superadminDavid && superadminDavid.name === 'Father Alex', 'Persona SUPERADMIN is Father Alex');
  assert(superadminDavid.capabilities.canAccessStudio === true, 'Superadmin Father Alex has canAccessStudio: true');
  assert(superadminDavid.capabilities.canPublish === true, 'Superadmin Father Alex has canPublish: true');
  assert(superadminDavid.capabilities.canApprove === true, 'Superadmin Father Alex has canApprove: true');
  ...
  assert(BetaIdentityProvider.getNamespacedSaveKey(superadminDavid) === 'koinonia.phase22_1.save.father_alex', 'Superadmin save key is namespaced to father_alex');
