...
function createResendTransport({ apiKey, from, replyTo = null, publicOrigin = null, fetchImpl = globalThis.fetch, timeoutMs = DEFAULT_TIMEOUT_MS } = {}) {
...
function createEmailTransportFromEnv(env = process.env, options = {}) {
    return createEmailTransport({
        ...
        publicOrigin:
            env.EMAIL_PUBLIC_ORIGIN ||
            env.KOINONIA_PUBLIC_ORIGIN ||
            null,
        ...options
    });
}
